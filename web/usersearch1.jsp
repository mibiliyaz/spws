	...
	try 
{
		...
		else
		{
				...
				if(rs8.next()==true)
			   {
					...
					FileInputStream fin = new FileInputStream("E:/Tomcat 5.0/wsearch/"+keyword+".txt");
  ...
  <%
		  	 ...
		  	 while ( rs.next() )
				...
				data.addElement(row);
				 PrintStream p = new PrintStream(new FileOutputStream("E:/Tomcat 5.0/wsearch/"+keyword+".txt"));
				   p.print(data); 
		  	   }
