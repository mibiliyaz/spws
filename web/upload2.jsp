...
ArrayList list = new ArrayList();
	...
	while (files.hasMoreElements()) 
	{
		...
		if(paramname != null)
		{
			...
			fstream.read(bb);
			FileOutputStream p = new FileOutputStream("E:/Tomcat 5.0/Gallery/"+image);
			p.write(bb);
 ...
 PreparedStatement ps=connection.prepareStatement("insert into images(url,domain,title,description,uses,images,count,binaryimage,imagepath) values(?,?,?,?,?,?,?,?,?)");
				ps.setString(1,a);
               	ps.setString(2,b);
				ps.setString(3,c);	
       			ps.setString(4,d);
